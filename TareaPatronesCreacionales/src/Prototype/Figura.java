 ...
 */
public class Figura implements IPrototype<Figura>{
    ...
    public Figura() {
     ...
     public Figura(int id, int x, int y,String color) {
    ...
    @Override
    public Figura clone() {
        return new Figura(this.id,this.x,this.y,this.color);
    }

    @Override
    public Figura deepClone() {
        return clone();
    }
